  ...
  return (
    <div className="container mx-auto my-6 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl rounded-lg bg-[#0f172a] px-4 py-4 sm:px-6 lg:px-8">
        {/* Info Bar - Top Center */}
        <div className="mb-4 flex flex-wrap items-center justify-center gap-2 text-xs text-gray-400 sm:text-sm">
        ...
        {/* Title and View Toggle - Bottom Row */}
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <h2 className="text-xl font-semibold text-blue-400 underline sm:text-2xl">
